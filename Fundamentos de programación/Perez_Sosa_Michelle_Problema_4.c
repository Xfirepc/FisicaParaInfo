/*Ejercicio 4
Implementar un algoritmo que cuente el n�mero de caract�res captados
desde teclado, determinar si es un d�gito o un car�cter o un espacio,
e imprimir por pantalla estos n�mero seg�n el tipo*/

#include <conio.h>
#include <stdio.h>
#include <stdlib.h>

//_______Funci�n para la limpieza de buffer_________
